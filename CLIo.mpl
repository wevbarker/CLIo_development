...
CLIo:=module()
description "The CLIo package (Clio is a Greek muse of history) stands for `Command Line Interface options'."
option package;
export dit, fin;

dit:=proc(opts::set,message::string,n1:=NULL,n2:=NULL,n3:=NULL,n4:=NULL,n5:=NULL)::NULL;
